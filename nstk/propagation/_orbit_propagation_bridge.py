...
JAVA_ORBIT_PROPAGATION_CLASS = "com.nstk.propagation.OrekitOrbitPropagationBridge"
_LEGACY_JAVA_ORBIT_PROPAGATION_CLASS = "com.nebula.propagation.OrekitOrbitPropagationBridge"
...
def _class_file(classes_dir: Path) -> Path:
    return classes_dir / "com" / "nstk" / "propagation" / "OrekitOrbitPropagationBridge.class"
...
def get_orbit_propagation_bridge_class():
    ...
    try:
        ...
        return jpype.JClass(_LEGACY_JAVA_ORBIT_PROPAGATION_CLASS)
